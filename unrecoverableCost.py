...
print(f"Average Annual Cost of Equity: ${average_cost_of_capital * price_of_home:,.2f}")
print(f"Average Monthly Cost of Equity: ${(average_cost_of_capital * price_of_home)/12:,.2f}")
